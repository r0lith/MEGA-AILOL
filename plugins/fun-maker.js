...
let handler = async (m, { conn, usedPrefix, command }) => {
    ...
    let pp = await conn.profilePictureUrl(who, 'image').catch(_ => 'https://i.ibb.co/gZLqPThn/Riruru.png')
    let me = await conn.profilePictureUrl(m.sender, 'image').catch(_ => 'https://i.ibb.co/gZLqPThn/Riruru.png')
